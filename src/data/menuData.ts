...
export const menuData: MenuItem[] = [
  // ⭐ Manager’s Picks
  {
    ...
    image: '/ManagersPizza_TandooriChicken.png',
    price: 18.99,
    sizes: [
  ...
  },
  {
    ...
    category: "Manager's Picks",
    image: '/ManagersPizza_TandooriPaneer.png',
    price: 18.99,
    sizes: [
      { name: 'Small (10")', price: 18.99 },
      { name: 'Medium (12")', price: 22.99 },
  ...
  },
  {
    ...
    category: "Manager's Picks",
    image: '/Manager_sPizza_ChickenTikkaMasalaPizza.png',
    price: 18.99,
    sizes: [
      { name: 'Small (10")', price: 18.99 },
      { name: 'Medium (12")', price: 22.99 },
  ...
  },
  {
    ...
    category: "Manager's Picks",
    image: '/ManagersPizza_CurryVeggie.png',
    price: 18.99,
    sizes: [
      { name: 'Small (10")', price: 18.99 },
      { name: 'Medium (12")', price: 22.99 },
  ...
  },
  {
    ...
    category: "Manager's Picks",
    image: '/ManagersPizza_ChilliPaneer.png',
    price: 18.99,
    sizes: [
      { name: 'Small (10")', price: 18.99 },
      { name: 'Medium (12")', price: 22.99 },
  ...
  },
  {
    ...
    category: "Manager's Picks",
    image: '/Manager_sPizza_MasalaSupremeFeastPizza.png',
    price: 18.99,
    sizes: [
      { name: 'Small (10")', price: 18.99 },
      { name: 'Medium (12")', price: 22.99 },
  ...
  // 🍕 Signature Pizzas
  { id: 'veggie-supreme', name: 'Veggie Supreme', description: 'Mushrooms, black olives, bell peppers, red onions, and fresh sliced tomatoes on red sauce. ', category: 'Signature Pizzas', price: 18.99, image: '/Manager_sPizza_VeggieSupremePizza.png' },
  ...
  { id: 'white-delight', name: 'White Delight', description: 'Spinach, Mushrooms, Tomatoes , red onions, Artichoke hearts and fresh green onions on creamy garlic sauce. ', category: 'Signature Pizzas', price: 18.99, image: '/Manager_sPizza_WhiteDelightPizza.png' },
  { id: 'garlic-ranch-feast', name: 'Garlic Ranch Feast', description: 'Pepperoni, sausage, mushrooms, tomatoes, black olives, and fresh green onions on creamy garlic sauce. ', category: 'Signature Pizzas', price: 18.99, image: '/Manager_sPizza_GarlicRanchFeastPizza.png' },
  {
    id: 'custom-pizza',
  ...
  { id: 'the-hamazon', name: 'The Hamazon', description: 'Ham, pineapple, tomatoes, red onions, bacon, and fresh green onions on our sweet & Spicy Sauce .', category: 'Signature Pizzas', price: 18.99, image: '/Manager_sPizza_TheHamazonPizza.png' },
  { id: 'ham-it-up', name: 'Ham It Up', description: 'Ham and Pineapple on Red Sauce.', category: 'Signature Pizzas', price: 18.99, image: '/Manager_sPizza_HamItUpPizza.png' },
  { id: 'meaty-union', name: 'Meaty Union', description: 'Ham, Salami, Pepperoni, sausage, and ground beef on Red Sauce. ', category: 'Signature Pizzas', price: 18.99, image: '/Manager_sPizza_MeatyUnionPizza.png' },
  { id: 'pizza-margherita', name: 'Pizza Margherita', description: 'Baby tomatoes and fresh basil leaves on Red Sauce. ', category: 'Signature Pizzas', dietary: ['V'], price: 18.99, image: '/Manager_sPizza_MargheritaPizza.png' },
  { id: 'garlic-rooster', name: 'Garlic Rooster', description: 'Grilled Chicken, Mushrooms, Tomatoes, Red onions and fresh green onions on creamy garlic sauce.', category: 'Signature Pizzas', price: 18.99, image: '/Manager_sPizza_GarlicRoosterPizza.png' },
  { id: 'tangy-bbq', name: 'Tangy BBQ', description: 'BBQ chicken, bacon, and pineapple on tangy BBQ sauce.', category: 'Signature Pizzas', price: 18.99, image: '/Manager_sPizza_TangyBBQPizza.png' },
  ...
  { id: 'can-fanta-pineapple', name: 'Fanta Pineapple', description: 'Pineapple Fanta in a 12oz can', category: 'Cans', price: 2.50, image: '/fanta-pa-can.png' },
  { id: 'can-sprite', name: 'Sprite', description: 'Lemon-lime Sprite in a 12oz can', category: 'Cans', price: 2.50, image: '/sprite-can.png' },
  ...
  { id: 'can-root-beer', name: 'Root Beer', description: 'Classic root beer in a 12oz can', category: 'Cans', price: 2.50, image: '/rootbeer-can.png' },
  // --- Beverages: 20oz ($4.50) ---
